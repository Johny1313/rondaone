...
## Atualização 0.9.7.6.1

A baseline permanece a mesma, com uma correção isolada no leitor externo: Band Adapter V2, JSON-LD estruturado/VideoObject e ordem de retry corrigida. O primeiro retry é direct-first; o segundo retry deep pode priorizar Browser. Não houve alteração de schema D1, Mesa, Ronda, Multi-AI, Quality Gate, Cost Governor ou watchdog.
