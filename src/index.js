import { handleRonda, runRondaSchedule } from './ronda/router.js';
...
export default {
  async fetch(request,env,ctx){
    ...
    if(url.pathname==='/api/platform/status') return json({ok:true,platform:'RONDA ONE',version:'0.7.0',modules:{ronda:true,design:true,ai:!!env.AI,projects:!!env.DB},billingMode:'free-only'});
