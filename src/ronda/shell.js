export const PLATFORM_VERSION='0.9.7.5.11';
export const RONDA_EDITORIAL_VERSION='2.9.7.5.10';
export const ASSET_REV=`${RONDA_EDITORIAL_VERSION}-097-forma-production`;
export const HOTFIX_REV='0.9.7.5.11-external-link-browser-read-hotfix';
