export const PLATFORM_VERSION='0.9.2.1';
export const RONDA_EDITORIAL_VERSION='2.9.2';
export const ASSET_REV=`${RONDA_EDITORIAL_VERSION}-0921-admin-login`;
export const HOTFIX_REV='0.9.2.1-admin-login';
