export const PLATFORM_VERSION='0.8.9';
export const RONDA_EDITORIAL_VERSION='2.8.5';
export const ASSET_REV=`${RONDA_EDITORIAL_VERSION}-089-mesa-filter-recovery`;
export const HOTFIX_REV='0.8.9-mesa-filter-recovery';
