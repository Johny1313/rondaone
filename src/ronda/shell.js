export const PLATFORM_VERSION='0.8.8.1';
export const RONDA_EDITORIAL_VERSION='2.8.5';
export const ASSET_REV=`${RONDA_EDITORIAL_VERSION}-0881-lock-mesa-hotfix`;
export const HOTFIX_REV='0.8.8.1-lock-mesa-hotfix';
