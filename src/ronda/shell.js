export const PLATFORM_VERSION='0.8.8';
export const RONDA_EDITORIAL_VERSION='2.8.5';
export const ASSET_REV=`${RONDA_EDITORIAL_VERSION}-088-direct-article-template`;
export const HOTFIX_REV='0.8.8-direct-article-template';
