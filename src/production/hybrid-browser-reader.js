...
export const READER_VERSION = "hybrid-reader-v1";
export const EVIDENCE_VERSION = "ronda-evidence-pack-v1-reader-v1";
export const CAROUSEL_PIPELINE_VERSION = "carousel-stability-baseline-v1";
