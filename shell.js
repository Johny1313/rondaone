...
export const INTEGRATION_SCRIPT=`<script src="/ronda/ronda-one-integration.js?v=${PLATFORM_VERSION}" defer></script>`;
...
function versionMainAssets(html){
  ...
  // tenham ou não query string. Este é o caso que a 0.7.6 não cobria sempre.
  out=out
