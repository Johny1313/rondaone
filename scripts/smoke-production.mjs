...
const status=await get('/api/platform/status');if(status.version!=='0.9.7.4.2')throw new Error(`Versão publicada ${status.version||'desconhecida'}; esperado 0.9.7.4.2`);
...
console.log('Smoke production v0.9.7.4.2: OK');
