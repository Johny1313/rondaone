...
assert.match(mesa,/Gerenciamento editorial/);
assert.match(mesa,/Produção/);
assert.match(mesa,/Aprovação/);
assert.match(mesa,/Finalização/);
assert.match(mesa,/Concluído/);
assert.doesNotMatch(mesa,/api\/sources\/diagnostics/);
