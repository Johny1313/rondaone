...
const worker=read("src/ronda/v285/index.js"),app=read("public/ronda/app.js"),design=read("public/design/index.html"),mesa=read("public/ronda/editorial-mesa.js"),production=read("public/ronda/production-view.js"),filters=read("public/ronda/editorial-mesa-filters.js"),css=read("public/ronda/editorial-mesa.css"),platform=read("src/index.js");
...
assert.match(filters,/function matches/);assert.match(filters,/>=75/);assert.match(filters,/latestLimit=20/);assert.match(filters,/function filterLinked/);assert.match(mesa,/event-mesa/);assert.match(mesa,/Mesa Editorial/);assert.match(production,/production-board/);
