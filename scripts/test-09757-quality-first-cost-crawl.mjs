...
// Freeze dos componentes herdados da 5.6 que continuam intencionalmente imutáveis.
// engine.js possui lock próprio na nova baseline porque integra o Hybrid Browser Reader.
const frozen={
