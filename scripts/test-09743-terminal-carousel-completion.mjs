...
assert.match(engine,/PRODUCTION_SCHEMA_VERSION = "(?:0\.9\.7\.4\.[345678]|0\.9\.7\.5(?:\.1)?)"/);
...
assert.match(index,/engineVersion:"0\.9\.7\.5\.1"/);

console.log('v0.9.7.4.3 Terminal Completion preservado com coordenador único v0.9.7.5.1 OK');
