...
assert.match(shell,/(?:0\.9\.7\.4\.(?:10-forma-download-all-slides|11-newsroom-os-phase-1|12-newsroom-os-hardening)|0\.9\.7\.5(?:-adaptive-retry-no-repeat|\.1-unified-no-hang-coordinator|\.2-mesa-production-separated|\.3-read-budget-regression-fix|\.4-carousel-open-recovery-fix|\.5-retry-lease-handoff-fix|\.6-stuck-production-watchdog-hotfix|\.7-quality-first-cost-crawl|\.10-carousel-stability-baseline|\.12-carousel-56-full-lock))/);
