...
const checks=[
  ...
  [/deadline=startedAt\+(?:20|55)\*1000/.test(design),'deadline visual limitado'],
  [design.includes('/fallback'),'fallback automático exposto no FORMA'],
  [/age>=(?:10000|32000)/.test(design),'fallback antecipado'],
  [/PRODUCTION_HARD_DEADLINE_MS = (?:30_000|45_000)/.test(engine),'deadline curto de backend'],
